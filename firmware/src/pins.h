...
#define EXTRUDER_4_MOTOR_DRIVER_STEP    A6
#define EXTRUDER_4_MOTOR_DRIVER_DIR     A7
#define EXTRUDER_4_MOTOR_DRIVER_ENABLE  A2
#define EXTRUDER_4_HEATER               45
#define EXTRUDER_4_FILAMENT_SENSOR      15
#define EXTRUDER_4_THERMISTOR           A10

#define EXTRUDER_5_MOTOR_DRIVER_STEP    46
